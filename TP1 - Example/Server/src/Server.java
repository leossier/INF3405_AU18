...
public class Server {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String serverAddress = JOptionPane.showInputDialog(frame,"Enter IP Address and Port of the Server:","Welcome to the Capitalization Program", JOptionPane.QUESTION_MESSAGE);
        int port = 5000;
